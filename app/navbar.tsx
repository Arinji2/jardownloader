  ...
  return (
    <div className="md:w-[30%] z-[1000] w-full h-[100px] bg-theme-background md:h-[100svh]  sticky top-0 overflow-auto flex flex-col items-center justify-start  border-theme-accent border-b-[5px] md:border-0">
      ...
      <div
        className={`${
          open ? "w-[100%] " : "w-[0%] "
        }transition-all navbar z-[900] ease-in-out duration-700 md:w-[100%] h-[100svh] md:h-full left-0 origin-left flex flex-col items-center justify-start gap-5 mt-10 md:static fixed top-14 bg-theme-background  overflow-auto`}
      >
        <div
