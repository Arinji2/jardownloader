...
export default async function Home() {
  return (
    <div className="w-full h-full flex flex-col items-center justify-start gap-7 z-5 md:bg-theme-accent">
      <SliderAnimation />
      <ParentAnimation>
        ...
        <div className="md:w-[60%] text-center w-[90%] text-theme-foreground font-medium text-[10px] md:text-[15px]">
          VANILLA MC IS THE ORIGINAL MINECRAFT SERVER SOFTWARE. IT LACKS IN
          PROPER OPTIMIZATIONS AND FEATURES, BUT IS THE BEST FOR A PURE
